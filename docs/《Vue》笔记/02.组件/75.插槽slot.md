...
<p class="codepen" data-height="400" data-theme-id="light" data-default-tab="js,result" data-user="MotainZhang" data-slug-hash="XWbdpBp" style="height: 400px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;" data-pen-title="插槽slot">
  <span>See the Pen <a href="https://codepen.io/MotainZhang/pen/XWbdpBp">
  插槽slot</a> by MotainZhang (<a href="https://codepen.io/MotainZhang">@MotainZhang</a>)
